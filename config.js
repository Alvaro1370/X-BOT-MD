...
const SESSION_ID = process.env.SESSION_ID || "A-S-W-I-N-S-P-A-R-K-Y:6b9ea94fc717fd615d3391fbf47ac5e5";
const SUDO = process.env.SUDO || '917012984396';
const AUTO_STATUS_VIEW = process.env.AUTO_STATUS_VIEW || "flase";
